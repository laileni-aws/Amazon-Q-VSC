...
* Expected format: \`type: subject...\`
    ...
    * documentation: https://github.com/aws/amazon-q-vscode/blob/master/CONTRIBUTING.md#pull-request-title
* Hint: *close and re-open the PR* to re-trigger CI (after fixing the PR title).
`
        : `Pull request title matches the [expected format](https://github.com/aws/amazon-q-vscode/blob/master/CONTRIBUTING.md#pull-request-title).`
...
function _test() {
    const tests = {
        ' foo: bar': 'type contains whitespace: " foo"',
